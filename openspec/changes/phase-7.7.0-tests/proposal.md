...
- The file contains exactly one `#[test]` per phase-7.7 scenario, each marked `#[ignore = "awaits phase-7.7"]` (28 unique test functions covering 29 scenarios).
