...
Phases 1-9 complete the core Cairn framework. The final campaign phase makes Cairn usable from editors, agent environments, and additional domains without changing the map semantics.
...
- `cairn-lsp` server for editor autocomplete, hover, diagnostics, and jump-to-definition over blueprint IDs, artefacts, and edges.
...
- Hover on blueprint IDs returns node metadata and attached artefact summary.
