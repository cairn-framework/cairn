...
1. **Read Proposal**
   ```bash
   python3 ".claude/skills/cflx-workflow/scripts/cflx.py" show <change-id>
   ```
...
2. **Validate Change Status**
   ```bash
   python3 ".claude/skills/cflx-workflow/scripts/cflx.py" list
   python3 ".claude/skills/cflx-workflow/scripts/cflx.py" show <id>
   ```
...
3. **Run Archive**
   ```bash
   python3 ".claude/skills/cflx-workflow/scripts/cflx.py" archive <id> --yes
   ```
...
4. **Verify Results**
   ...
   ```bash
   python3 ".claude/skills/cflx-workflow/scripts/cflx.py" validate --strict
   ```
...
# List specs
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" list --specs

# Show change details
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" show <id>

# Show JSON output
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" show <id> --json

# Show deltas only
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" show <id> --json --deltas-only

# Validate change
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" validate <id> --strict
...
python3 ".claude/skills/cflx-workflow/scripts/cflx.py" archive <id> --yes --skip-specs
```
