...
# Review existing specs
 python3 ".claude/skills/cflx-proposal/scripts/cflx.py" list --specs
...
Run validation:
```bash
 python3 ".claude/skills/cflx-proposal/scripts/cflx.py" validate <id> --strict
```
...
Use `python3 ".claude/skills/cflx-proposal/scripts/cflx.py"` for all Conflux operations:

```bash
# List existing changes
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" list

# List specs
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" list --specs

# Show change details
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" show <id>

# Validate proposal
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" validate <id> --strict

# Validate proposal with implementation-evidence warnings
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" validate <id> --strict --evidence warn

# Validate proposal with implementation-evidence errors
python3 ".claude/skills/cflx-proposal/scripts/cflx.py" validate <id> --strict --evidence error
```
