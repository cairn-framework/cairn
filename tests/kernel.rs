...
"#,
    ...
    eprintln!("report1 symbols: {:?}", report1.symbols);
    eprintln!("report2 symbols: {:?}", report2.symbols);
...
"#,
    ...
    eprintln!("target_reports: {:?}", result.target_reports);
    eprintln!("findings: {:?}", result.graph.findings);
